...
class Ui_adminPage(object):
    def setupUi(self, adminPage):
        ...
        self.user_reg_btn.setGeometry(QtCore.QRect(40, 200, 321, 41))
        self.user_reg_btn.setObjectName("user_reg_btn")
        self.logout_btn = QtWidgets.QPushButton(self.centralwidget)
        self.logout_btn.setGeometry(QtCore.QRect(40, 300, 321, 41))
        ...
        self.acc_mngBtn.setGeometry(QtCore.QRect(40, 250, 321, 41))
